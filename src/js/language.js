import typed1 from './typed';
import imagenSpanish from '../img/usa.png'
import imagenEnglish from '../img/espana.png'

document.addEventListener('DOMContentLoaded', function () {

  const  typeOne  = typed1;
  console.log(typeOne.strings);
  ...
  const textos = {
    espanol: {
      ...
      paragraph: "Ver testimoniales en LinkedIn",
    },
    ingles: {
      hello: "Hello, I am",
      ...
      paragraph: "See testimonials on LinkedIn",
    }
  };
  ...
  const iconos = {
    espanol: `${imagenSpanish}`,
    ingles: `${imagenEnglish}`
  };
  ...
  function cambiarIdioma() {
    ...
    if (idiomaActual === "espanol") {
      ...
      typed1.strings = [
        '<span id="title1">Front-End Developer</span>',
        '<span id="title2">Systems Engineer</span>',
        '<span id="title3">Software Developer</span>',
      ];
    ...
    document.getElementById("inicio-2").textContent = textos[idiomaActual].home;
    document.getElementById("acerca-2").textContent = titulos[idiomaActual].aboutMe;
    document.getElementById("proyectos-2").textContent = textos[idiomaActual].projects;
    document.getElementById("testimoniales-2").textContent = titulos[idiomaActual].testimonials;
    document.getElementById("contactame-2").textContent = titulos[idiomaActual].contactMe;
    ...
    document.getElementById("paragraph").textContent = textos[idiomaActual].paragraph;
